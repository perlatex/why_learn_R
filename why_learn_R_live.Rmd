...
刚才讲到了大神Hadley Wickham， 他搞了一个好东西叫 tidyverse，那么tidyverse 能干什么事情呢？ 他将数据科学分成了6个环节，
...
```{r out.width = '100%', echo = FALSE}
knitr::include_graphics("images/rstudio-cloud-01.png")
```
...
## 以最快的速度获得一次成功的经验
云平台演示 **一步一步**的方式呈现可视化， 得出好看  

## 以最快的速度获得一次成功的经验

```{r out.width = '100%', echo = FALSE}
knitr::include_graphics("images/rstudio-cloud-02.png")
```
...
## 以最快的速度获得一次成功的经验
我们有编程的需求，然后云平台演示， 得出 好学

## 以最快的速度获得一次成功的经验

```{r out.width = '100%', echo = FALSE}
knitr::include_graphics("images/rstudio-cloud-03.png")
```
...
## 以最快的速度获得一次成功的经验
我们有可重复性研究的需求，然后然后云平台演示， 得出好玩

## 以最快的速度获得一次成功的经验

```{r out.width = '100%', echo = FALSE}
knitr::include_graphics("images/rstudio-cloud-04.png")
```


## 生成pdf
第一生成pdf的时候，需要安装一次tinytex，然后以后就不需要了
...
<!-- - What is R ?    R是一个统计编程语言，里面有个大神 在他的改造下，R语法符合人的思维、代码可读性强、深受大家喜欢，-->
<!-- - What is R used for ?     好像可以做很多事情，让我有了一次亲密体验 -->
<!-- - why R ? -- R很美，能帮我解决4个残酷 所以值得拥有-->
<!-- - How to use R ? 下次见 -->
