...
| 序号 	| 内容         	| 代码演示                                        	|
|------	|--------------	|-------------------------------------------------	|
| 1    	| 统计         	| [1_stats.R](./exercises/1_stats.R)              	|
| 2    	| 可视化       	| [2_visual.R](./exercises/2_visual.R)       	      |
| 3    	| 探索性分析   	| [3_eda.R](./exercises/3_eda.R)         	          |
| 4    	| 可重复性报告 	| [4_reproducible.R](./exercises/4_reproducible.R) 	|

- 看演示请进入 <https://rstudio.cloud/project/1847233>
...
颜控的小姐姐们，想生成pdf版本，Console中输入`tinytex::install_tinytex()`
回车后等待2分钟，然后重新点击`Knit`就可以看到pdf了
